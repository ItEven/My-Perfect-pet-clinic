...
namespace EasyCharacterMovement
{
    ...
    public sealed class CharacterMovement : MonoBehaviour
    {
        ...
        public void UpdateCurrentGround(ref FindGroundResult inGroundResult)
        {
        ...
        public void SetRotation(Quaternion newRotation)
        {
            ...
            rotatingObj.rotation = updatedRotation;
        }
        ...
        public void SetPositionAndRotation(Vector3 newPosition, Quaternion newRotation, bool updateGround = false)
        {
            ...
            rotatingObj.SetPositionAndRotation(rotatingObj.position, updatedRotation);
        }
        ...
        public void RotateTowards(Vector3 worldDirection, float maxDegreesDelta, bool updateYawOnly = true)
        {
            ...
            Vector3 characterUp = rotatingObj.up;
        ...
        private void UpdateCachedFields()
        {
            ...
            updatedRotation = rotatingObj.rotation;
